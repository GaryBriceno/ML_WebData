...
#Se agregoesta linea por un error que se presento al utilizar tokenize
...
class NaiveBayesClassifier(object):
    ...
    def document_probability(self, item, category):
        ...
        for feature in features:
            print
            "%s - %s - %s" % (feature, category, self.weighted_prob(feature, category))
    ...
    def train_from_data(self, data):
        ...
        #Esta linea estaba comentada - GB
...
if __name__ == '__main__':
    labels = ['artes', 'sports']  # these are the categories we want
    data = {}
    for label in labels:
        f = open(label, 'r')
    ...
    print  (nb.probability(
        "elephants like to play cricket.",
        'artes'))
    print  (nb.probability(
        "elephants like to play cricket.",
        'sports'))